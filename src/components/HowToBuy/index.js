...
<section
className=" tw-bg-[#0F0F0F] tw-pt-14 md:tw-p-4  "
>
<div className="tw-w-4/4 md:tw-w-[90%] tw-m-auto tw-mt-20">
  <h1 className="tw-uppercase tw-text-center tw-text-white tw-text-4xl tw-font-zendots tw-text-z-10">
    How To Buy
  </h1>
  <div className="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-items-center">
    <div className="tw-p-10 md:tw-p-4">
      <div className="tw-relative">
        <div class="tw-border-2 tw-absolute tw-border-[#F0C238] tw-border-dashed tw-h-full tw-left-5"></div>
        ...
        <div class="tw-z-20 tw-flex tw-items-center order-1 tw-bg-black tw-shadow-xl tw-w-10 tw-h-10 tw-rounded-full tw-my-auto tw-absolute tw-left-0">
          <h1 class="tw-mx-auto tw-font-semibold font-zendots tw-text-2xl tw-text-[#F0C238]">
            01
          </h1>
        </div>
        <div className="tw-pl-10">
          <p className="tw-font-zendots tw-font-semibold tw-text-2xl tw-mt-10 tw-text-[#F0C238] tw-ml-2">Connect Wallet</p>
          <p className="tw-text-lg tw-text-white tw-p-2">
            To purchase APS Token you need to connect your wallet,
        ...
        <div className="tw-pt-5">
          <div class="tw-z-20 tw-flex tw-items-center order-1 bg-black shadow-xl tw-w-10 tw-h-10 tw-rounded-full tw-my-auto tw-absolute tw-left-0">
            <h1 class="mx-auto tw-font-semibold font-zendots tw-text-2xl tw-text-[#F0C238]">
              02
            </h1>
          </div>
          <div className="tw-pl-10">
            <p className="tw-font-semibold tw-font-zendots tw-mt-2 tw-ml-2 tw-text-2xl tw-text-[#F0C238]">
              SELECT PAYMENT TYPE
            </p>
            <p className="tw-text-lg tw-text-white tw-p-2">
        ...
        <div className="tw-pt-5">
          ...
          <div className="tw-pl-10">
            <p className="tw-font-zendots tw-mt-2 tw-ml-2 tw-text-[#F0C238] tw-text-2xl tw-font-semibold">Buy APS Token</p>
            <p className="tw-text-lg tw-text-white tw-p-2">
        ...
        <div className="tw-pt-5">
          ...
          <div className="tw-pl-10">
            <a href="#home">
              <button className="tw-bg-[#F0C238] tw-text-black tw-mt-1 tw-ml-2 tw-px-10 tw-p-2 tw-rounded">
                Buy Now
              </button>
            </a>
          </div>
